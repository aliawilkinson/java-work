...
public class ExampleAccount2 {
	...
	public static void main(String[] args) {
		...
		balance = 1000.00; withdrawalAmount = 50002.21; 
		...
		//withdrawalAmount > balance ? System.out.println("Withdrawal will result in an overdraft!") : System.out.println("Withdrawal is approved!");
		if (withdrawalAmount > balance) {
			System.out.println("Withdrawal will result in an overdraft!");
		} else {
			System.out.println("Withdrawal is approved!");
		}
		...
		if (depositAmount <= 0) {
			...
			System.out.println("Deposit is approved! New balance is " + balance);
		}
	}
}
